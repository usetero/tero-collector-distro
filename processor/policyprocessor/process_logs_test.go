...
// TestProcessLogs_TypedMatchers exhaustively covers equals/gt/gte/lt/lte typed
// comparison matchers end-to-end: a drop-on-match policy is compiled and
// evaluated against a single log record with the "value" attribute set per
// case (or left unset for the absent-field cases).
func TestProcessLogs_TypedMatchers(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
		...
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Equals{Equals: &policyv1.Value{Value: &policyv1.Value_BoolValue{BoolValue: false}}},
			},
			wantDrop: false,
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Equals{Equals: &policyv1.Value{Value: &policyv1.Value_IntValue{IntValue: 42}}},
			},
			wantDrop: true,
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Equals{Equals: &policyv1.Value{Value: &policyv1.Value_IntValue{IntValue: 43}}},
			},
			wantDrop: false,
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Equals{Equals: &policyv1.Value{Value: &policyv1.Value_DoubleValue{DoubleValue: 3.14}}},
			},
			wantDrop: true,
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Equals{Equals: &policyv1.Value{Value: &policyv1.Value_DoubleValue{DoubleValue: 2.71}}},
			},
			wantDrop: false,
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Equals{Equals: &policyv1.Value{Value: &policyv1.Value_DoubleValue{DoubleValue: 5.0}}},
			},
			wantDrop: true,
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Equals{Equals: &policyv1.Value{Value: &policyv1.Value_IntValue{IntValue: 5}}},
			},
			wantDrop: true,
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Equals{Equals: &policyv1.Value{Value: &policyv1.Value_HexValue{HexValue: "deadbeef"}}},
			},
			wantDrop: true,
		},
		{
		...
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Gt{Gt: &policyv1.NumericValue{Value: &policyv1.NumericValue_IntValue{IntValue: 50}}},
			},
			wantDrop: true,
		},
		{
		...
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Gte{Gte: &policyv1.NumericValue{Value: &policyv1.NumericValue_IntValue{IntValue: 50}}},
			},
			wantDrop: true,
		},
		{
		...
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Lt{Lt: &policyv1.NumericValue{Value: &policyv1.NumericValue_DoubleValue{DoubleValue: 2.0}}},
			},
			wantDrop: true,
		},
		{
		...
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Lte{Lte: &policyv1.NumericValue{Value: &policyv1.NumericValue_DoubleValue{DoubleValue: 2.0}}},
			},
			wantDrop: true,
		},
		{
		...
		},
		{
			...
			matcher: &policyv1.LogMatcher{
				Field: &policyv1.LogMatcher_LogAttribute{LogAttribute: attrPath},
				Match: &policyv1.LogMatcher_Gt{Gt: &policyv1.NumericValue{Value: &policyv1.NumericValue_IntValue{IntValue: 5}}},
			},
			wantDrop: false,
		},
		{
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			policies := []*policyv1.Policy{
				{
					...
					Target: &policyv1.Policy_Log{
						Log: &policyv1.LogTarget{
							Match: []*policyv1.LogMatcher{tc.matcher},
							Keep:  "none",
						},
					},
				},
			...
			if tc.wantDrop {
				assert.Equal(t, 0, result.ResourceLogs().Len(), "expected record to be dropped")
			} else {
				require.Equal(t, 1, result.ResourceLogs().Len(), "expected record to be kept")
				assert.Equal(t, 1, result.ResourceLogs().At(0).ScopeLogs().At(0).LogRecords().Len())
			}
		})
	}
